...
var h4var = document.querySelectorAll('h4');
var h1var = document.querySelectorAll('h1');

console.log(h4var.length)
for (var i=0; i < h4var.length; i++) {
    
    h4var[i].setAttribute("style", "font-size: 30px; color:blue; font-weight:bold;");
}
h1var[0].setAttribute("style", "padding: 10px; margin: 0;")
